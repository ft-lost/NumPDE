 ...
 * @param T final time
 * @param rec takes in an Eigen::VectorXd as argument and stores for later visualizations
...
Eigen::VectorXd semiLagrangePureTransport(int M, int K, double T, RECORDER &&rec = [](const Eigen::VectorXd &) ->void{}){
