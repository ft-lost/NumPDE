...
/**
 * @brief implements the solution of a pure transport problem , relies on SUAdvectionElemMatrixProvider
 * @param fe_space shared pointer to the finite element space the pde is solved on
 * @return the vector of expansion coefficients of the finite-element solution with respect to the standard nodal basis of S_0^2(M)
 */
