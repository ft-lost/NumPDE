...
namespace GuyerKrumhansl::test {
    ...
    TEST(GuyerKrumhansl, timestepping_GKHeat){
        ...
        auto result = GuyerKrumhansl::timestepping_GKHeat(T,L,M,mu0,zeta0,rho,sigma,mu,kappa);
    ...
    TEST(GuyerKrumhansl, track_GKHeatEnergy)
    {
        ...
        auto result = GuyerKrumhansl::track_GKHeatEnergy(T,L,M,mu0,zeta0,rho,sigma,mu,kappa);
