...
# NOTICE: This script is the work of the LLVM Project, taken from
# https://github.com/llvm/llvm-project/tree/main/clang-tools-extra/clang-tidy/tool/run-clang-tidy.py
# on 12-04-2024.
